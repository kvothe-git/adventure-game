...
public class NoRotMovement : MonoBehaviour
{
	public const string startingPositionKey = "starting position";
	public SaveData playerSaveData;

	[SerializeField]
	Transform playerInputSpace = default, model = default;
	...
	void UpdateModel()
    {
		Material modelMaterial = normalMaterial;
		if(Climbing)
        {
			modelMaterial = climbingMaterial;
        }
		else if (Swimming)
        {
			modelMaterial = swimmingMaterial;
        }
		...
		Quaternion targetRotation = Quaternion.FromToRotation(model.up, rotationAxis) * model.localRotation;
		model.localRotation = Quaternion.RotateTowards(model.localRotation, targetRotation, modelAlignSpeed * distance);
	}
